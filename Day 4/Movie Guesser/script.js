...
explanation.innerHTML = movies[index].explanation;

const answer = movies[index].title;
...
submitInput.addEventListener('click', (event) => {
    ...
    if (submission == answer) {
        ...
        subDiv.innerHTML = "Try again!";
        subDiv.classList.add('alert-warning');
    }
    cardBody.append(subDiv);
})
